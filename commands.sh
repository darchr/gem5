...
build/ARM/gem5.opt -re --debug-flags=ProtocolTrace,MBRUBY,RubySlicc --debug-start=10475603669250 --outdir=m5out-restore128core/NPB-C/sp saga-chi-npb-gapbs/configs/npb-restore-tree.py --benchmark=sp --size=C