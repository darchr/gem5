...
system.bridge2.plugIn(system.bridge1)
print "successfully reconnected the ports"

m5.simulate(1000000)
print "successfully simulated with bridge2"

m5.drain()

system.bridge2.unplug()
print "successfully disconnected the ports"

system.bridge1.plugIn(system.bridge2)
print "successfully reconnected the ports"

m5.simulate()
print "successfully simulated with bridge1"
