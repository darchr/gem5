...
system.membus2.plugIn(system.membus)
print "successfully reconnected the ports"

m5.simulate(1000000)
print "successfully simulated with membus2"

m5.drain()

system.membus2.unplug()
print "successfully disconnected the ports"

system.membus.plugIn(system.membus2)
print "successfully reconnected the ports"

m5.simulate()
print "successfully simulated with membus"
