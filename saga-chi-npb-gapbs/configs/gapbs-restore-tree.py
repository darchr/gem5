...
local_memory_size = gapbs_mem_size[f"{args.benchmark}.{args.size}"]
...
def handle_exit_event():
    for num_iterations in range(10):
        ...
        m5.setMaxTick(m5.curTick() + 100_000_000)  # simulate another 100 ms
...
m5.setMaxTick(m5.curTick() + 100_000_000)
