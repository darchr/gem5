...
ckpt_path_base = "/home/babaie/projects/coherence/saga-darchrgem5-march28/gem5/chkpts-outdir-128cores/npb/cktpts"
ckpt_path = f"{ckpt_path_base}/{args.size}/{args.benchmark}"
...
processor = SimpleProcessor(
    cpu_type=CPUTypes.O3, isa=ISA.ARM, num_cores=num_cores
)
